...
class PolaroidMode(Enum):
   FULL_POLAROID = ImageSettings(
       portrait_factor=ImageFactor(0.02,0.02,0.02,0.13,0.93, 0.5, 0.96,0.5, 0,30.44,42.14, "left", "left"),
       landscape_factor=ImageFactor(0.02,0.02,0.02,0.125,0.93, 0.5, 0.97,0.5, 0,31.44,44.14, "left", "left")
   )
   INSTA_SQUARED = ImageSettings(
       portrait_factor=ImageFactor(0,0,0.07,0.13,0.94, 0.5, 0.975,0.5, 0,34.44,48.14, "left", "left"),
       landscape_factor=ImageFactor(0,0,0.07,0.145,0.92, 0.5, 0.96,0.5, 0,30.44,44.14, "left", "left"),
       portrait_blur=True
   )
   HALF_POLAROID = ImageSettings(
       portrait_factor=ImageFactor(0, 0, 0.03, 0.13, 0.93, 0.5, 0.955, 0.5, 0,30.44,41.14, "left", "left"),
       landscape_factor=ImageFactor(0, 0, 0.03, 0.145, 0.91, 0.5, 0.945, 0.5, 0,30.44,44.14, "left", "left")
   )
   QUARTER_POLAROID = ImageSettings(
       portrait_factor=ImageFactor(0, 0, 0, 0.11, 0.945, 0.5, 0.97, 0.5, 0,30.44,42.14, "left", "left"),
       landscape_factor=ImageFactor(0, 0, 0, 0.12, 0.925, 0.5, 0.965, 0.5, 0,30.44,44.14, "left", "left")
   )

   FULL_POLAROID_COMPACT = ImageSettings(
       portrait_factor=ImageFactor(0.02,0.02,0.02,0.13,0.945, 0.05, 0.96,0.95, 0,33.44,48.14, "left", "left"),
       landscape_factor=ImageFactor(0.02,0.02,0.02,0.125,0.94, 0.05, 0.96,0.95, 0,32.44,44.14, "left", "left"),
       is_compacted=True
   )
   INSTA_SQUARED_COMPACT = ImageSettings(
       portrait_factor=ImageFactor(0,0,0.07,0.13,0.96, 0.05, 0.975,0.95, 0,33.44,48.14, "left", "left"),
       landscape_factor=ImageFactor(0,0,0.07,0.145,0.94, 0.05, 0.955,0.95, 0,31.44,44.14, "left", "left"),
       portrait_blur=True,
       is_compacted=True
   )
   HALF_POLAROID_COMPACT = ImageSettings(
       portrait_factor=ImageFactor(0, 0, 0.03, 0.13, 0.945, 0.05, 0.955, 0.95, 0,34.44,48.14, "left", "left"),
       landscape_factor=ImageFactor(0, 0, 0.03, 0.145, 0.935, 0.05, 0.945, 0.95, 0,30.44,44.14, "left", "left"),
       is_compacted=True
   )
   QUARTER_POLAROID_COMPACT = ImageSettings(
       portrait_factor=ImageFactor(0, 0, 0, 0.11, 0.955, 0.05, 0.97, 0.95, 0,33.44,47.14, "left", "left"),
       landscape_factor=ImageFactor(0, 0, 0, 0.12, 0.945, 0.05, 0.96, 0.95, 0,30.44,44.14, "left", "left"),
       is_compacted=True
   )
